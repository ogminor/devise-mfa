...
Gem::Specification.new do |gem|
  ...
  gem.summary       = %q{Time Based MFA OTP/rfc6238 compatible authentication for Devise}
  gem.homepage      = "http://github.com/ogminor/devise-mfa"
  ...
  gem.add_runtime_dependency 'rqrcode_png'
end
